...
description: "An algorithm for finding the most separated points in a cloud of
points."
categories:
  - r
  - qualpalr
...
```{r greedy_approach, fig.height=3, fig.width=6,fig.align='center',fig.cap='Numbers note the order the points were picked in.', fig.align = "center"}
set.seed(1)
# find n points
n <- 3
...
```{r new_approach, fig.height=3, fig.width=6,fig.align='center',fig.cap='The new algorithm for picking points.'}
