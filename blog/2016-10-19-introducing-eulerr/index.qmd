...
**eulerr** is an [R](https://www.r-project.org) package that
generates area-proportional euler diagrams to display set
...
venneuler, however, is written in java, preventing R users from browsing
the source code (unless they are also literate in java) or contributing.
...
[@wilkinson2012], which is given by the sums of squared residuals divided by the
...
of our input. Were it otherwise, we would do best to stop here and
look for another way to visualize our data. (I suggest the excellent
...
Details of the implementation will be left for a future
vignette but almost completely resemble the approach documented
