...
graph TD
    A[25 min work] -->|Repeat four times| B[5 min break]
    B --> A
    A -->|Fifth time| C[15 min long break]
    C --> A
```
...
timer, which I named **Tomat** (Swedish 🇸🇪 for tomato).
...
![Audio alert for the start of a work session](break-to-break.wav)
