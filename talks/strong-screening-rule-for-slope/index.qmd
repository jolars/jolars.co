...
description: >
  A talk for the Statistical Learning Seminar on my work with Jonas Wallin on
  the first predictor screening rule for SLOPE, a sparse regression method.
abstract: |
...
image-alt: >-
  Talk recording showing screening performance on simulated data as the
  regularization strength changes.
