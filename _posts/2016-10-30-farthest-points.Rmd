...
```{r greedy_approach, fig.height=5, fig.width=9,fig.aling='center',fig.cap='Numbers note the order the points were picked in.'}
set.seed(1)
# find n points
n <- 3
...
```{r new_approach, fig.height=5, fig.width=9,fig.aling='center',fig.cap='The new algorithm for picking points.'}
