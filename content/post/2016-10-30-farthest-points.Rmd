...
header:
  image: "headers/farthest-points.png"
...
```{r greedy-approach, fig.height=5, fig.width=9, fig.cap='Numbers note the order the points were picked in.'}
set.seed(1)
# find n points
n <- 3
...
```{r new-approach, fig.height=5, fig.width=9,fig.aling='center',fig.cap='The new algorithm for picking points.'}
