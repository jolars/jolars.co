...
```{r residual_plot, fig.cap='Residuals for the eulerr fit.', fig.height = 5, fig.width = 5}
...
```{r eulerr_plot, fig.width=3.5, fig.height=3.5, fig.show='hold', fig.cap='eulerr plots can be modified in every possible way.'}
plot(fit2)
