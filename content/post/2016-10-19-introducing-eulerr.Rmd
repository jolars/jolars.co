...
header:
  image: "headers/euler_ellipses.svg"
summary: "This is an introduction to my package, eulerr, an R-package that
          computes and plots Euler diagrams for set relationships."
---
...
```{r eulerr-plot, fig.width=2.5, fig.height=2.5, fig.show='hold', fig.cap='eulerr plots can be modified in every possible way.'}
plot(fit2)
