...
Eunoia creates area-proportional Euler diagrams using circles, ellipses, squares, and
rectangles. While most Euler diagram software is limited to circles (which often
can't accurately represent set relationships), Eunoia uses numerical
