...
Nov 13, 2024
:   **The Choice of Normalization Directly Affects Feature Selection in Regularized
    Regression**
...
2024--now
:   Computational Statistics, *Department of Mathematical Sciences, University of
    Copenhagen*
...
:   Generalized linear models penalized with the sorted L1 norm
    ...
    Python package (<https://pypi.org/projects/sortedl1>), Julia
    package (<https://github.com/jolars/SLOPE.jl>), C++ library
