...
:   A high-performance graph package for working with
...
:   Automatic generation of color palettes for 
    data visualization

    Author and maintainer

    C++ library (<https://github.com/jolars/qualpal>),
    R package (<https://cran.r-project.org/package=qualpalr>),
    Web app (<https://qualpal.cc>)
